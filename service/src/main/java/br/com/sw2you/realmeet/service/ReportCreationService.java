...
public class ReportCreationService {
    ...
    public ReportCreationService(ReportHandlerResolver reportHandlerResolver,
    ...
    public void createAllocationReport(LocalDate dateFrom, LocalDate dateTo, String email, String reportFormatStr) {
        var reportData = AllocationReportData.builder().dateFrom(dateFrom).dateTo(dateTo).email(email).build();
        creteReport(ALLOCATION, email, reportFormatStr, reportData);
    }

    private void creteReport(ReportHandlerType reportHandlerType, String email, String reportFormatStr, AllocationReportData reportData
    ) {
