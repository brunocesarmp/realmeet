...
class PageUtilsUnitTest extends BaseUnitTest {
    ...
    void testNewPageableWhenPageIsNegative() {
        assertThrows(
                ...
                () -> newPageable(-1, null, 10, null, SORTABLE_FIELDS)
        );
    }
    ...
    void testNewPageableWhenLimitIsInvalid() {
        assertThrows(
                IllegalArgumentException.class,
                () -> newPageable(null, 0, 10, null, SORTABLE_FIELDS)
        );
    }
    ...
    void testNewPageableWhenOrderByIsNull() {
        assertThrows(
                IllegalArgumentException.class,
                () -> newPageable(null, 0, 10, null, null)
        );
    }
    ...
    void testNewPageableWhenOrderByIsEmpty() {
        assertThrows(
                IllegalArgumentException.class,
                () -> newPageable(null, 0, 10, null, emptyList())
        );
    }
    ...
    void testNewPageableWhenOrderByFieldIsInvalid() {
        assertThrows(
                ...
                () -> newPageable(null, null, 10, "invalid", SORTABLE_FIELDS)
        );
    }
